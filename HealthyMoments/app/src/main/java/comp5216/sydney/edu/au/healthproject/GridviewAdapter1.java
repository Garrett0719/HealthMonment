...
public class GridviewAdapter1 extends BaseAdapter{
    ...
    public GridviewAdapter1(ArrayList<Sport> list, Context context,String extra_data) {
    ...
    public void initDate(String extra_data){
        ...
        SharedPreferences sp =context.getSharedPreferences(dateNowStr+"_sport", MODE_PRIVATE);
        String data=sp.getString(extra_data+"Sport_data",null);
        System.out.println(extra_data+": "+data);
        String[] food;
        if(data!=null) {
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = inflater.inflate(R.layout.gridviewitem1, null);
            ...
            holder.percent.setText(getIsSelected().get(position)+"min");
            holder.cb.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
                @Override
                public void onProgressChanged(SeekBar seekBar, int progress, boolean fromUser) {
                    finalHolder.percent.setText(String.valueOf(progress*2)+"min");
